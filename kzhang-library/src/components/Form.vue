    ...
    <div class="row">
      <div class="col-12 col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="row mb-3">
            <div class="col-12 col-sm-6">
              <label class="form-check-label me-3"> Australian Resident? </label>
              <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input" id="isAustralianYes" :value="true"
                  @blur="() => validateIsAustralian(true)" v-model="formData.isAustralian">
                <label class="form-check-label" for="isAustralianYes">Yes</label>
              </div>
              <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input" id="isAustralianNo" :value="false"
                  @blur="() => validateIsAustralian(true)" v-model="formData.isAustralian">
...
const validateReason = (blur) => {
  ...
  if (text.length > maxChars) {
    errors.value.reason = `Text must be ${maxChars} characters or less`;
    formData.value.reason = text.substring(0, maxChars);
    return;
  }

  if (!text) {
    errors.value.reason = blur ? "Reason is required" : null;
